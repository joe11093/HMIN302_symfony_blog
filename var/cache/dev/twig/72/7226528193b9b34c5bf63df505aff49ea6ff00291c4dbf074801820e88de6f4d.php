...
class __TwigTemplate_d70e944bd776e9fcf95dd917e6c3a71ec5187067e0f6cd169fd33d50a90d29d4 extends Template
{
    private $source;
    private $macros = [];
...
($context["forms_by_hash"] ?? null), twig_get_attribute($this->env, $this->source, $context["error"], "origin", [], "any", false, false, false, 509), [], "array", true, true, false, 509)) {
    ...
    {
        return new Source("", "@WebProfiler/Collector/form.html.twig", "/var/www/html/symfony/groblog/vendor/symfony/web-profiler-bundle/Resources/views/Collector/form.html.twig");
    }
}
